(function() {
  var MainViewController, ServiceController, SuburbanScheduleController, SuburbanTransportController, TestController, UrbanScheduleController, UrbanTransportController, transportControllers;
  ...
  UrbanTransportController = (function() {
    ...
    UrbanTransportController.prototype.showFullName = function(bus) {
      this.$scope.showFullName = true;
      return this.$scope.currentBus = bus;
    };

    UrbanTransportController.prototype.hideFullName = function(bus) {
  ...
  UrbanScheduleController = (function() {
    function UrbanScheduleController($scope, $routeParams, $filter, TransportManager, TimeManager, filtertimeFilter) {
      var ctrl, i, _i, _j;
      this.$scope = $scope;
    ...
    UrbanScheduleController.prototype.isSelectedWorkdays = function() {
    ...
    UrbanScheduleController.prototype.isSelectedWeekend = function() {
    ...
    UrbanScheduleController.prototype.setCurrentWorkdays = function() {
    ...
    UrbanScheduleController.prototype.setCurrentWeekend = function() {
    ...
    UrbanScheduleController.prototype.setCurrentTime = function() {
      var d, h, m;
      d = new Date();
      h = d.getHours();
      m = d.getMinutes();
    ...
    UrbanScheduleController.prototype.setNullTime = function() {
      this.$scope.selectedHour = 0;
      return this.$scope.selectedMinute = 0;
    };

    UrbanScheduleController.prototype.setAllStationsChecked = function() {
    ...
    UrbanScheduleController.prototype.stationClicked = function(selectedStation) {
      var station, _i, _len, _ref;
      if (this.initialCheckedStations) {
        ...
        return selectedStation.selected = !selectedStation.selected;
      }
    };

    UrbanScheduleController.prototype.isTimeExpired = function(time) {
    ...
    UrbanScheduleController.prototype.hideButton = function() {
    ...
    UrbanScheduleController.prototype.showShortDescription = function() {
    ...
    UrbanScheduleController.prototype.isStationActive = function(selectedStation) {
      if (selectedStation != null) {
        return selectedStation.selected;
      }
    };

    UrbanScheduleController.prototype.isStationShown = function(index) {
    ...
    UrbanScheduleController.prototype.isNoMenu = function() {
      if (this.currentTransport != null) {
    ...
    return UrbanScheduleController;
  ...
  transportControllers.controller('UrbanScheduleController', ['$scope', '$routeParams', '$filter', 'TransportManager', 'TimeManager', 'filtertimeFilter', UrbanScheduleController]);
